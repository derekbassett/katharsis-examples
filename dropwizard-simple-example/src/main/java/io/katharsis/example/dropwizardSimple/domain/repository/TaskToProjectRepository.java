...
public class TaskToProjectRepository implements RelationshipRepository<Task, Long, Project, Long> {
    ...
    @Override
    public Project findOneTarget(Long objectId, String fieldName, QueryParams requestParams) {
    ...
    @Override
    public Iterable<Project> findManyTargets(Long objectId, String fieldName, QueryParams requestParams) {
        Task task = taskRepository.findOne(objectId, requestParams);
        try {
